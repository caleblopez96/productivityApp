export function Nav() {
    return (
        <div className="flex flex-col items-center justify-center gap-4 border-b-2 border-b-gray-300 box-border w-full">
            <nav className="w-full">
                <ul className="flex justify-evenly w-full list-none p-0 m-0">
                    <li className="flex items-center justify-center p-2 hover:bg-gray-100 rounded-lg cursor-pointer transition-colors">
